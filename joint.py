...
class Arm:
    ...
    def move_to_coord(self, coord_name):
        coord = self.pointset.get(coord_name)
        current_pos = self.tcp_pos()
        new_pos = [coord[0], coord[1], coord[2], coord[3], coord[4], coord[5]]
        self.arm.move_to_point(new_pos, 30)
...
# arm.move_to_coord('base_coor')
# arm.move_to_coord('left_down_coor')
# arm.move_to_coord('left_coor')

# arm.move_to_coord('right_down_coor')
# arm.move_to_coord('right_coor')
# arm.move_to_coord('base_coor')
# arm.move_to_coord('front_coor')
# arm.move_to_coord('base_coor')


# arm.move_to_coord('far_down_coor')
# arm.move_to_coord('far_up_coor')
for i in range(1,11):
    arm.move_to_coord(str(i))
